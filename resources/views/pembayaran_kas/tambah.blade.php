        ...
        <div class="card-body">
            ...
            <form action="{{ route('pembayaran.store') }}" method="post">
                ...
                <div class="input-group mb-3">
                    <select class="form-select select2" aria-label="Default select example" id="anggota"
                        ...
                        @foreach ($anggota as $item)
                            <option value="{{ $item->id }}">Nama : {{ $item->Nama }}, Nim : {{ $item->Nim }}
                            </option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" id="selama" name="selama" value="{{ old('selama') }}" min="1"   oninput="update_total(this)">
                    <br>
                    <span>bulan</span>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="total_nominall" name="total_nominall"
                        value="{{ old('total_nominal') }}" readonly>
                </div>
